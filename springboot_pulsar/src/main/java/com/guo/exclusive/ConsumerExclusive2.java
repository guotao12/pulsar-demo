 ...
 */
public class ConsumerExclusive2 {

    //Pulsar集群中broker的serviceurl
    private static final String brokerServiceurl = "pulsar://192.168.10.50:6650";
    //需要订阅的topic name
    private static final String topicName = "my-topic1";
    //订阅名
    private static final String subscriptionName = "my-sub1";
...
//            该receive方法同步接收消息（消费者进程被阻塞，直到有消息可用）
            ...
            try {
                System.out.printf("消费的消息是：", new String(message.getData()) + i++);
