...
public class ProducerKey_Shared {
    ...
    public static void main(String[] args) throws PulsarClientException {
        ...
        ProducerKey_Shared pro = new ProducerKey_Shared();
        //异步发送100条消息
...
//        pro.SyncSend(client, producer);
    ...
    public void AsyncSend(PulsarClient client, Producer producer) throws PulsarClientException {
        ...
        for (int i = 0; i < 160; i++) {
            ...
            CompletableFuture future = producer.newMessage().key(key).value(content.getBytes()).sendAsync();
